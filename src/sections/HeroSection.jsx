      ...
      <div className="w-full md:w-[90%] bg-white rounded-3xl shadow-md p-8 md:p-12 border border-gray-200 flex flex-col md:flex-row gap-10">
        ...
        <div className="md:w-[70%] text-gray-700 leading-relaxed text-lg font-[Georgia]">
          ...
          <p className="mb-6">
            ...
            material properties. On one hand, electric charge double layer (EDL)
            is utilized to control carrier accumulation/ depletion in
            solution-processed semiconductor thin films. This approach leads to
            technologically relevant activity in the field of printed
            ...
            nanodielectrics, SANDs). The area of expertise of the group lies in
            solution processing/ printing of different metallic (pure metal,
            transparent conductors), semiconducting (oxides, carbon based, 2D
            semiconductors etc.) and insulator inks (CSPFEs, SANDs) towards
            fabrication of various functional devices, with a primary emphasis
            on field-effect devices.
          </p>
          ...
          <p>
            ...
            judicious selection of the magnetic material and the electrolyte is
            essential in order to promote either controlled surface chemical
            reaction (chemisorption, as in case of pseudocapacitors) or precise
            diffusion of ions inside the electrode material (as in case of
            intercalation-type batteries or fuel cells). Such electrochemical
            reactions, when fully reversible, may enable a voltage controlled
            tunable and dynamic variation in physical properties of bulk
            materials.
          </p>
        </div>
        ...
        <div className="md:w-[30%] flex flex-col items-center text-center">
          ...
          <div className="mt-4 text-[#0066cc] font-[Georgia] text-lg leading-snug">
            ...
            <div className="mt-3 space-y-1 text-[#004b99] text-base">
              ...
              <div className="flex items-center gap-2">
                <Mail size={18} />
                <span>subho.dasgupta@iisc.ac.in</span>
              </div>
            </div>
          </div>
        </div>
